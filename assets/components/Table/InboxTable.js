...
var after_review =
  "<button title='view detail' data-toggle='tooltip'><span class='material-icons' data-toggle='modal' data-target='#modal-reviewed>vi</span></button >";
...
$("#display tbody").on("click", "tr", (event) => {
  ...
  document.getElementById("In_totalleave").value =
...
$("#display tbody").on("click", "tr", (event) => {
  ...
  document.getElementById("RIn_totalleave").innerHTML =
    data.InpTotalleave + " day(s)";
