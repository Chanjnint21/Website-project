...
var action =
  "<button data-toggle='modal' +data+ data-target='#edit-UsM'><span class='material-icons' title='Edit' data-toggle='tooltip'>edit</span></button> <button  data-toggle='modal' data-target='#RemoveUser-modal'><span class='material-icons text-danger' title='Delete' data-toggle='tooltip' >cancel</span></button>";
...
function createuser() {
  ...
  if (
    ...
    document.getElementById("cf-password-validations").innerHTML =
